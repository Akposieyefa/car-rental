  ...
  <div class="container">
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        ...
        <div class="price_info">
        Selling Prize : <br/><br/>
          <p class="text-success">$<?php echo htmlentities($result->sellingprize); ?> </p>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <?php if ($_SESSION['login']) {?>
              <div class="form-group">
                <input type="submit" class="btn btn-block"  name="submit" value="Rent Car">
              </div>
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Book</a>
      ...
      <div class="sidebar_widget">
        <div class="widget_heading">
          <h5><i class="fa fa-dollars" aria-hidden="true"></i>Buy Now</h5>
          <small>For renting</small>
        </div>
        <form method="post">
        <?php if ($_SESSION['login']) {?>
          <inp
            <div class="form-group">
              <input type="submit" class="btn btn-block"  name="submit" value="Buy Car">
            </div>
            <?php } else { ?>
...
<?php
$bid=$_SESSION['brndid'];
$sql="SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.sellingprize,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.SeatingCapacity,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesBrand=:bid";
$query = $dbh -> prepare($sql);
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">Rental Prize: $<?php echo htmlentities($result->PricePerDay); ?></p>
              <p class="list-price">Selling Prize: $<?php echo htmlentities($result->sellingprize); ?></p>
